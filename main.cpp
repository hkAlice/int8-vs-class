...
int main()
{
    ...
    benchCall< int8_t, Int >( [&](){ benchSimpleAdd< int8_t >( _int8N ); }, [&](){ benchSimpleAdd< Int >( _int8C ); }, "benchSimpleAdd" );

    // you wouldn't cheat an int, would you?
    benchCmpVec< int8_t, Int >( _int8N, _int8C );

    benchCall< int8_t, Int >( [&](){ benchMulAhead< int8_t >( _int8N ); }, [&](){ benchMulAhead< Int >( _int8C ); }, "benchMulAhead" );
    ...
    benchCall< int8_t, Int >( [&](){ benchBubbleSort< int8_t >( _slice_int8N ); }, [&](){ benchBubbleSort< Int >( _slice_int8C ); }, "benchBubbleSort (SLICED)" );
